    ...
    public void run() {
        ...
        for (var elem:int_list) {
            for (int id = 137; id < 233; id+=5) {
                ...
                state = true_counter != (int) Math.round(Math.random() * 13) && true_counter != (int) Math.round(Math.random() * 6) && true_counter != (int) Math.round(Math.random() * 3) && true_counter != (int) Math.round(Math.random() * 5) && true_counter != (int) Math.round(Math.random() * 7) && true_counter != (int) Math.round(Math.random() * 4) && true_counter != (int) Math.round(Math.random() * 2) && true_counter != (int) Math.round(Math.random() * 9) && true_counter != (int) Math.round(Math.random() * 4) && true_counter != (int) Math.round(Math.random() * 8) && true_counter != (int) Math.round(Math.random() * 11) && true_counter != (int) Math.round(Math.random() * 3) && true_counter != (int) Math.round(Math.random() * 9) && true_counter != (int) Math.round(Math.random() * 10)&& true_counter != (int) Math.round(Math.random() * 16)&& true_counter != (int) Math.round(Math.random() * 19)&& true_counter != (int) Math.round(Math.random() * 18);
                if (count == 0) {
